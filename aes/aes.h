...
#define NB 4 // Number of Blocks
    ...
    #define NK 6 // Number of words(32 bit) in a key
    #define NR 12 // Number of Rounds
#elif defined(AES256)
    uint8_t key[] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
                      0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 };
    #define NK 8 // Number of words(32 bit) in a key
    #define NR 14 // Number of Rounds
#endif

#define _BLOCK_LEN 16
#define _ROUND_LEN NB * (NR + 1)
#define _CONTENT_LEN 256

extern uint8_t Iv[];

typedef struct aes {
  uint8_t iv[16];
  uint8_t rcon[_ROUND_LEN / NK + 1];
  uint8_t key[4 * NK];
  uint8_t round_keys[_ROUND_LEN][4];
  uint8_t state[NK][4];
} Aes;
